...
effects_plot <- ggplot(combined_dfs, aes(y = effect, x = .value, color=model)) +
  ...
  scale_color_manual(name = "Model",
                     values=c("black", "#639C6E", "red3"),
                     breaks=c('Empirical Data', '2D Model', 'No Tradeoff Model'),
                     labels=c("Empirical Data", '2D Model', 'No Tradeoff Model')) +
...
#save
# ggsave
ggsave("plots/effects_plot_notradeoff.jpg", effects_plot, dpi = 300, width = 6.5, height = 2.5, units = "in")
ggsave("plots/effects_plot_legend_notradeoff.jpg", legend, dpi = 300, width = 6.5, height = 0.5, units = "in")
