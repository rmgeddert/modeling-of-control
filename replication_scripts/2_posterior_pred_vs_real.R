...
posterior_2d <- read_csv("model_fitting/2D_model_replication/posterior_pred.csv") %>% 
  group_by(congruency, taskSequence, switchProp, incProp) %>% 
  median_qi(RT)

posterior_1d <- read_csv("model_fitting/1D_model_replication/posterior_pred.csv") %>%
  group_by(congruency, taskSequence, switchProp, incProp) %>%
  median_qi(RT)
...
ggsave("plots/posteriors_plot_replication.jpg", plot_2d + plot_1d, dpi = 300, width = 6.5, height = 4, units = "in")
ggsave("plots/posteriors_plot_legend_replication.jpg", legend, dpi = 300, width = 6.5, height = 0.5, units = "in")
